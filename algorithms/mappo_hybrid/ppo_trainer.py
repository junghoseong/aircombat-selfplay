...
class PPOTrainer():
    ...
    def ppo_update(self, policy: PPOPolicy, sample):
        ...
        obs_batch, share_obs_batch, discrete_actions_batch,continuous_actions_batch,all_continuous_actions_batch,discrete_embeddings_batch,continuous_embeddings_batch,\
              masks_batch, active_masks_batch, old_action_log_probs_batch, advantages_batch, \
    ...
    def train(self, policy: PPOPolicy, buffer: SharedHybridReplayBuffer):
        train_info = {}
