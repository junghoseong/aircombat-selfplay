...
env="MultipleCombat"
scenario="2v2/scenario2_curriculum_vspursue"
algo="mappo"
...
CUDA_VISIBLE_DEVICES=0 python train/train_jsbsim.py \
    ...
    --lr 3e-4 --gamma 0.99 --ppo-epoch 4 --clip-params 0.2 --max-grad-norm 2 --entropy-coef 1e-3 --mutual-support True --intrinsic-ratio 0.01 \
