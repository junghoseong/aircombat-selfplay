...
env="MultipleCombat_Hybrid"
scenario="2v2/scenario2_hybrid"
algo="mappo"
...
python train/train_jsbsim.py \
    ...
    --lr 3e-4 --gamma 0.99 --ppo-epoch 4 --clip-params 0.2 --max-grad-norm 2 --entropy-coef 1e-3 --mutual-support True --intrinsic-ratio 0.1 \
