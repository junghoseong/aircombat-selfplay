...
enm_policy_index = 0
episode_rewards = 0
experiment_name = "vs_loiter_with_missile"

env = SingleCombatEnv("scenario1/scenario1_curriculum_vs_loiter")
...
for i in [0, 30, 60, 120, 150, 180]:
    ...
    if render:
        env.render(mode='txt', filepath=f'curriculum_{i}_vs_loiter.acmi')
