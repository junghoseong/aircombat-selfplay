...
class SACActor(nn.Module):
    def __init__(self, args, obs_space, act_space, device=torch.device("cpu")):
        ...
        self.log_std_bounds = args.log_std_bounds # Add for SAC
        ...
        # (3) act module
        action_dim = act_space[0] * 2 # Add for SAC
        self.act = ACTLayer(action_dim, input_size, self.act_hidden_size, self.activation_id, self.gain)
