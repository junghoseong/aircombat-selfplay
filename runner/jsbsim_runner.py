...
class JSBSimRunner(Runner):
    ...
    def run(self):
        ...
        episodes = self.num_env_steps // self.buffer_size // self.n_rollout_threads # 총 몇 episode를 진행할 것인지를 여기서 결정
    ...
    def collect(self, step):
        self.policy.prep_rollout()  # set actor and critic to eval mode
    ...
    def restore(self, path):
        self.policy.actor.load_state_dict(torch.load(str(path)))
